...
<body>
	<form action="boss_User_Update_Save.jsp" name="join">
		...
		<div>
			...
			<div>
				<span class="txt_input">비번확인 : </span> <input type="password"
					name="pwd1" value="<%=rs.getString("PASSWORD")%>"> <input
					type="button" value="중복확인" onclick="fnPwdCheck()">
			</div>
			<div>
			...
			<div>
				<span class="txt_input">주소 :</span> <input type="text"
			...
			<div>
				<span class="txt_input">기간시작 :</span> <input type="date"
					name="start"
					value="<%=rs.getString("START_DATE") != null ? rs.getString("START_DATE") : ""%>">
			</div>
			<div>
				<span class="txt_input">기간끝 :</span> <input type="date" name="end"
					value="<%=rs.getString("END_DATE") != null ? rs.getString("END_DATE") : ""%>">
			</div>
			<div>
			...
			<div>
				<span class="select_input">취 미 :</span> <input type="text"
					name="hobby" value="<%=rs.getString("HOBBY")%>">
			</div>
			<div>
				<textarea name="comment" rows="20" cols="50"
					placeholder="가입인사를 입력해주세요." value="<%=rs.getString("CMT")%>"></textarea>
			</div>
			<div>
				<input type="submit" value="수정하기" onclick="return validateForm()">
				<input type="reset" value="초기화"> <input type="button"
					value="되돌아가기" onclick="history.back()">
			</div>
			<!-- 모달 창 -->
